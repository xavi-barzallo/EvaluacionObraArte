...
a persistence unit "EVA_Barzallo_Xavier_SRVPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/ups/edu/eva/EVA_Barzallo_Xavier_SRV/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "EVA_Barzallo_Xavier_SRV/pom.xml":
...
artifact ("EVA_Barzallo_Xavier_SRV.war") is already built. You can build
